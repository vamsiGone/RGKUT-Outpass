...
var chart = new ApexCharts(document.querySelector("#requests-chart"), options);
chart.render();

var chart2 = new ApexCharts(document.querySelector("#accepted-chart"), options2);
chart2.render();

var chart3 = new ApexCharts(document.querySelector("#rejected-chart"), options3);
chart3.render();
